...
public class UserException extends ReviewedStingException {
   ...
   public static class KeySignatureVerificationException extends UserException {
      public KeySignatureVerificationException(File f) {
         super(String.format("The signature in key file %s failed cryptographic verification. If this key was valid in the past, it's likely been revoked. Please see http://www.broadinstitute.org/gsa/wiki/index.php/Phone_home for help.", f.getAbsolutePath()));
      }
   }

   public static class UnreadableKeyException extends UserException {
      public UnreadableKeyException(File f, Exception e) {
         super(String.format("Key file %s cannot be read (possibly the key file is corrupt?). Error was: %s. Please see http://www.broadinstitute.org/gsa/wiki/index.php/Phone_home for help.", f.getAbsolutePath(), e.getMessage()));
      }
      ...
      public UnreadableKeyException(String message) {
         super(String.format("Key file cannot be read (possibly the key file is corrupt?): %s. Please see http://www.broadinstitute.org/gsa/wiki/index.php/Phone_home for help.", message));
      }
   }
   ...
   public static class CouldNotCreateReferenceIndexFileBecauseOfLock extends UserException.CouldNotCreateReferenceIndexFile {
      public CouldNotCreateReferenceIndexFileBecauseOfLock(File f) {
         super(f, "could not be written because an exclusive file lock could not be obtained. If you are running multiple instances of GATK, another GATK process is probably creating this file now, and has locked it. Please wait until this process finishes and try again.", (Exception)null);
      }
   }
   ...
   public static class CouldNotCreateReferenceIndexFile extends UserException {
      ...
      public CouldNotCreateReferenceIndexFile(File f, String message, Exception e) {
         super(String.format("Index file %s does not exist but could not be created because: %s. ", f, message) + (e == null ? "" : e.getMessage()));
      }
   }
   ...
   public static class DeprecatedArgument extends UserException.CommandLineException {
   ...
   public static class ReadMissingReadGroup extends UserException.MalformedBAM {
   ...
   public static class MissortedBAM extends UserException {
      public MissortedBAM(SortOrder order, File file, SAMFileHeader header) {
      ...
      public MissortedBAM(SortOrder order, String message) {
         super(String.format("Missorted Input SAM/BAM files: files are not sorted in %s order; %s", order, message));
      }

      public MissortedBAM(SortOrder order, SAMRecord read, String message) {
   ...
   public static class UnknownTribbleType extends UserException.CommandLineException {
      public UnknownTribbleType(String type, String message) {
         super(String.format("Unknown tribble type %s: %s", type, message));
      }
   }

   public static class BadArgumentValue extends UserException.CommandLineException {
      public BadArgumentValue(String arg, String message) {
         super(String.format("Argument %s has a bad value: %s", arg, message));
      }
   }

   public static class MissingArgument extends UserException.CommandLineException {
