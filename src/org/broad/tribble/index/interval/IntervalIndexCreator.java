...
public class IntervalIndexCreator implements IndexCreator {
    ...
    static int DEFAULT_FEATURE_COUNT = 600;
...
class MutableInterval {
    ...
    public Interval toInterval() {
        return new Interval(start,stop,new Block(startFilePosition, (int)(endFilePosition - startFilePosition)));
    }
