        ...
        try {
            ...
            if (c == null) {
                if (string.contains(",")) {
                    ...
                    int red = (rgb[0].indexOf('.') < 0) ? Integer.parseInt(rgb[0]) : (int)Float.parseFloat(rgb[0]);
                    int green = (rgb[1].indexOf('.') < 0) ? Integer.parseInt(rgb[1]) : (int)Float.parseFloat(rgb[1]);
                    int blue = (rgb[2].indexOf('.') < 0) ? Integer.parseInt(rgb[2]) : (int)Float.parseFloat(rgb[2]);
