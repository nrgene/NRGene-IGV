...
public class IGVUrlHelper implements URLHelper {
    ...
    public InputStream openInputStreamForRange(long start, long end, boolean addAcceptOctetStreameHeader) throws
        IOException {
        String byteRange = "bytes=" + start + "-" + end;
        Map<String, String> params = new HashMap<String, String>();
        params.put("Range", byteRange);
        if (addAcceptOctetStreameHeader) {
            params.put("Accept", "application/octet-stream");
        }
