 ...
 * @author jrobinso
 */
public class CompositeScore extends LocusScoreBase implements LocusScore {
    ...
    public CompositeScore(double start, double end, float value, float[] data, String[] probes, WindowFunction windowFunction) {
    	this((int)start, (int)end, value, data, probes, windowFunction);
    	this.startFraction = start - this.start;
    	this.endFraction = end - this.endFraction;
    }
