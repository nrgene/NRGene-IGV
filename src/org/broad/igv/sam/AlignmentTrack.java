...
public class AlignmentTrack extends AbstractTrack implements DragListener {
    ...
    public String getValueStringAt(String chr, double position, int y, ReferenceFrame frame) {
        ...
        if ( renderOptions.isShowTooltip() || isSpecial )
    ...
    public static class RenderOptions {
        ...
        public Map<String, String> getPersistentState() {
            ...
            if (isShowTooltip()) {
                attributes.put("showTooltip", String.valueOf(isShowTooltip()));
            }
            if (isShowTrackSeparator()) {
                attributes.put("showTrackSeparator", String.valueOf(isShowTrackSeparator()));
            }
        ...
        public void restorePersistentState(Map<String, String> attributes) {
            ...
            if (value != null) {
                setShowTooltip(Boolean.parseBoolean(value));
            }
            value = attributes.get("showTrackSeparator");
            if (value != null) {
                setShowTrackSeparator(Boolean.parseBoolean(value));
            }
        }
    ...
    class PopupMenu extends IGVPopupMenu {
        ...
        PopupMenu(final TrackClickEvent e) {
            ...
            add(TrackMenuUtils.getReloadMenuItem(tracks));
            TrackMenuUtils.addMoveMenuItem(this, tracks);
