...
import org.broad.igv.track.ExternalToolManager;
...
public class PeakTrackMenu extends IGVPopupMenu {
    ...
    private void init(final TrackClickEvent trackClickEvent) {
        ...
        add(TrackMenuUtils.getChangeFontItem(tracks));
        add(TrackMenuUtils.getChangeFontColorItem(tracks));

        ExternalToolManager.getInstance().addToolsToMenu(this, tracks);
