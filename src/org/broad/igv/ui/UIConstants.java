...
public class UIConstants {
    ...
    final static public String GET_SESSION_INFO_TOOLTIP = "Get path of current session";
    final static public String GET_STATUS_TRACKER_INFO_TOOLTIP = "Get information of progress and elapse time of activities";
    ...
    final static public String LINKTO_SESSION_TOOLTIP = "Build a link to the named session";
    ...
    final static public String NEW_PANEL_TOOLTIP = 
    		"Creates a new panel";
    final static public String DELETE_PANELS_TOOLTIP = 
    		"Delete empty panels";
    ...
    //final public static String DEFAULT_SERVER_GENOME_ARCHIVE_LIST = "file:nrgene_genomes.txt";
    
    final public static String CANNOT_ACCESS_SERVER_GENOME_LIST = "The Genome server is currently inaccessible.";
    final public static String CANNOT_MAP_GENOME_LOCUS = "Genome locus mapping failed";
    ...
    final static public String GENOME_LIST_SEPARATOR2 = "--SEPARATOR2--";

    /**
     * Nrgene
     */
    final static public String NRGENE_LINK_TEMPLATE = "http://localhost/igv/link.php?session=$1";
    //final static public String NRGENE_LINK_TEMPLATE = "http://localhost/~drorkessler/nrgene1/link.php?session=$1";
