...
public class Main {
        ...
        EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    if ( IGVMainFrame.isAppStreamMaximized() )
                    ...
                    MessageUtils.showMessage("<html>A fatal error was encountered on startup: <br>" +
                            e.toString() + "<br>" +
                            "Please contact " + PreferenceManager.SUPPORT_EMAIL);
                    System.exit(-1);
                }
            }
        });
    ...
    private static void initializeLookAndFeel() {
        ...
        */
        ...
        if (Globals.IS_LINUX || Globals.IS_WINDOWS ) {
            try {
    ...
    public static void initializeLog() {
        ...
        layout.setConversionPattern("%p [%d{ISO8601}] [%t] [%F:%L]  %m%n");
        ...
        log.info("igv.log appender threshold: " + appender.getThreshold().toString());
    ...
    static class IGVArgs {
        ...
        private String portMultiRange = null;
        ...
        private void parseArgs(String[] args) {
            ...
            CmdLineParser.Option portMultiRangeOption = parser.addStringOption('r', "portMultiRange");
            ...
            portMultiRange = (String) parser.getOptionValue(portMultiRangeOption);
        ...
        public String getPortMultiRange() {
    ...
    public static boolean isSessionFile(String file)
    {
    	// split on extension of file. trim out parameters of url
    	int		index = file.indexOf('?');
    	if ( index > 0 )
    		file = file.substring(0, index);
    	
    	return file.endsWith(".xml") || file.endsWith(".php") || file.endsWith(".php3") || file.endsWith(".jsp");    	
    }
}
