...
public class DataPanelPainter {
    ...
    final private void draw(Track track, Rectangle rect, RenderContext context) {
    	...
    	log.debug("rendering: " + track.getName());
    	IGV.getStatusTracker().startActivity(track.getName(), "rendering");
        ...
        log.debug("rendered: " + track.getName() + " (" + (System.currentTimeMillis() - started) + "ms)");
    	IGV.getStatusTracker().finishActivity(track.getName(), "rendering", System.currentTimeMillis() - started);
    }
}
