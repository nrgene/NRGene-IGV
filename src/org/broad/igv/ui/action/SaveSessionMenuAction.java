...
public class SaveSessionMenuAction extends MenuAction {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        File initFolder = currentSessionFilePath == null 
        		? PreferenceManager.getInstance().getLastSessionDirectory() 
        		: (new File(currentSessionFilePath).getParentFile());
        ...
        try {
            ...
            IGV.getMainFrame().setTitle(UIConstants.APPLICATION_NAME + " - Session: " + sf.getAbsolutePath());
