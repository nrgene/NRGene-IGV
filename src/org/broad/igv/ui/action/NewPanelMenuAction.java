 ...
 * @author jrobinso
 */
public class NewPanelMenuAction extends MenuAction {

    static Logger log = Logger.getLogger(NewPanelMenuAction.class);
    IGV mainFrame;

    public NewPanelMenuAction(String label, int mnemonic, IGV mainFrame) {
        super(label, null, mnemonic);
        this.mainFrame = mainFrame;
        setToolTipText(UIConstants.NEW_PANEL_TOOLTIP);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        NamedRunnable runnable = new NamedRunnable() {
            public void run() {
            	...
            	String		panelName = "Panel_" + UUID.randomUUID().toString();
            	
            	IGV.getInstance().getDataPanel(panelName);
        ...
        IGV.getInstance().getMenuBar().removeAllItems();
        IGV.getInstance().getMenuBar().addAllItems();
        (new NrgeneDumpFrameHierarchy()).dump(IGV.getMainFrame());
