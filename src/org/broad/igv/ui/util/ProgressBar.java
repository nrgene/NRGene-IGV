...
public class ProgressBar extends JPanel
    ...
    private static Logger log = Logger.getLogger(ProgressBar.class);
    ...
    public static ProgressBar showProgressDialog(Frame dialogsParent, String title, ProgressMonitor monitor, boolean closeOnCompletion) {
    	return showProgressDialog(dialogsParent, title, monitor, closeOnCompletion, 0);
    }
    public static ProgressBar showProgressDialog(Frame dialogsParent, String title, ProgressMonitor monitor, boolean closeOnCompletion, int nestLevel) {

    	if ( ProgressDialog.isAlreadyShowing )
    		log.info("isAlreadyShowing!");
        ProgressDialog.isAlreadyShowing = true; // To prevent mutiple dialogs at same time
        ProgressDialog progressDialog = null;
        
        int				vofs = nestLevel * 60;			
        ...
        if (dialogsParent == null) {
            ...
            // Center on screen
            UIUtilities.centerWindow(progressDialog, vofs);
        } else {
        }
